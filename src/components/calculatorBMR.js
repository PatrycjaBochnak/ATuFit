...
class CalculatorBMR extends Component {
  ...
  render() {
    ...
    let result;
    if (this.state.bmr) {
      result = <div className="resultBMR">Your basic metabolism is: {this.state.bmr.toFixed(0)} calories</div>;
    }

    let resultAct;
    if (this.state.bmr) {
      resultAct = <div className="resultTDEE">Your total metabolism is {this.state.finalResult.toFixed(0)} calories</div>;
    }
